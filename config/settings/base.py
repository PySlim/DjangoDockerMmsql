...
#Sidgro/
APPS_DIR = ROOT_DIR / "sidgro"
env = environ.Env()

READ_DOT_ENV_FILE = env.bool("DJANGO_RED_DOT_ENV_FILE", default=False)
if READ_DOT_ENV_FILE:
    env.red_env(str(ROOT_DIR / ".env"))
...
MIGRATION_MODULES = {"sites": "sidgro.contrib.sites.migrations"}
# AUTHENTICATION
# ------------------------------------------------------------------------------
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sidgro.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "sidgro.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "sidgro.users.adapters.SocialAccountAdapter"
